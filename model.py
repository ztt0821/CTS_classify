...
from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet, mamba_resnet
...
def generate_model(opt):
    ...
    if opt.model == 'resnet':
        ...
        model = densenet.generate_model(model_depth=opt.model_depth,
                                        ...
                                        conv1_t_stride=opt.conv1_t_stride,
                                        no_max_pool=opt.no_max_pool)
    elif opt.model == 'mambaresnet':
        model = mamba_resnet.generate_model(model_depth=opt.model_depth,
                                      n_classes=opt.n_classes,
                                      n_input_channels=opt.n_input_channels,
                                      shortcut_type=opt.resnet_shortcut,
                                      conv1_t_size=opt.conv1_t_size,
